...
``` bash
cd ..
python train.py --train-path data/wider-train.lst --val-path data/wider-val.lst --gpus 0 --batch-size 32 --lr 0.001 --num-class 1 --num-example 12880 --class-names 'face' --voc07 False --label-width 9842
```